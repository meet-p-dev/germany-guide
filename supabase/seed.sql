...
insert into tasks (category_id, slug, title_en, title_de, summary, audience, sort_order) values
  ...
  ((select id from task_categories where slug = 'work'), 'qualification-recognition', 'Recognition of foreign qualifications', 'Anerkennung', 'Get your foreign degree or vocational training officially recognized for the German job market.', '{worker,refugee,non-eu,family}', 1),
  ...
  ((select id from task_categories where slug = 'daily-life'), 'driving-license', 'Converting a driving license', 'Führerscheinumschreibung', 'Exchange your foreign driving license for a German one — rules depend on the issuing country.', '{worker,student,eu,non-eu,family}', 3)
...
-- ---------------------------------------------------------------- support resources
-- Refugee / asylum-seeker support resources for the /journey/refugee page.
-- 25 verified rows (20 national + 5 city-level: berlin×2, cologne, hamburg, munich).
-- No natural key, so we delete-then-reinsert (matching the solutions/commuter_areas
-- convention). Re-runnable. Table itself comes from migration 0007_support_resources.
-- All rows verified_at 2026-07-06 and active = true.
delete from support_resources;
insert into support_resources (name, url, category, description, region, source, verified_at, active) values
('BAMF — Asylum and international protection (portal hub)', 'https://www.bamf.de/EN/Themen/AsylFluechtlingsschutz/asylfluechtlingsschutz-node.html', 'asylum_procedure', 'Official English-language hub of the Federal Office for Migration and Refugees (BAMF) on asylum and international protection, linking to service info, local advice and FAQs. Free, no login.', null, 'BAMF — "Asylum and international protection"', '2026-07-06', true),
('BAMF — Ankunft in Deutschland (arrival & registration in the asylum procedure)', 'https://www.bamf.de/DE/Themen/AsylFluechtlingsschutz/AblaufAsylverfahrens/AnkunftRegistrierung/ankunftregistrierung-node.html', 'asylum_procedure', 'Official BAMF page (German) on the duty to report to a competent authority on arrival when seeking asylum, and the stages of the procedure (application, distribution, reception, screening). Free.', null, 'BAMF — "Ankunft in Deutschland"', '2026-07-06', true),
('BAMF — Beratungsangebote (free legal information for asylum applicants: auRA / AVB)', 'https://www.bamf.de/DE/Themen/Asyl/Beratungsangebote/beratungsangebote-node.html', 'asylum_procedure', 'Official BAMF page on the free legal information available to asylum applicants throughout all phases of the administrative procedure ("unentgeltliche Rechtsauskunft"), plus independent asylum-procedure counselling. Free, nationwide.', null, 'BAMF — "Beratungsangebote"', '2026-07-06', true),
('Germany4Ukraine — official BAMF/federal portal for people fleeing Ukraine', 'https://www.germany4ukraine.de/EN/startseite_node.html', 'asylum_procedure', 'Official BAMF/federal-government portal for people fleeing Ukraine — entry/residence, accommodation, healthcare, work, integration courses, family topics. Free. Available in German, English, Russian and Ukrainian.', null, 'BAMF / Germany4Ukraine portal', '2026-07-06', true),
('BAMF-NAvI — official integration-course / counselling finder', 'https://bamf-navi.bamf.de/en/Themen/Integrationskurse/', 'integration_language', 'Official BAMF locator to find integration courses, vocational language courses, and counselling/authority addresses near any German postal code. Free to use.', null, 'BAMF-NAvI — "Welcome to BAMF-NAvI"', '2026-07-06', true),
('Migrationsberatung.org — official cross-provider MBE portal', 'https://www.migrationsberatung.org/de/', 'counseling', 'Official cross-provider information and locator portal for Migrationsberatung für erwachsene Zugewanderte (MBE) — counseling for adult immigrants on housing, finances, language, employment, health insurance and residence questions. Independent, free of charge, confidential.', null, 'migrationsberatung.org — "Migrationsberatung für erwachsene Zugewanderte"', '2026-07-06', true),
('mbeon — official multilingual online migration counselling (app + web)', 'https://www.mbeon.de/en/', 'counseling', 'Official digital arm of the federal MBE program — connects adult immigrants (28 and older; under-28s are referred to Youth Migration Services) with real MBE counsellors online / via app. Free and confidential; typical response within about 48 hours. Available in several languages including German, English, Arabic, Russian, Ukrainian and Persian.', null, 'mbeon.de — "Online counselling - flexible and multilingual"', '2026-07-06', true),
('Jugendmigrationsdienste (JMD) — youth migration counselling', 'https://www.jugendmigrationsdienste.de/en/', 'counseling', 'Free counselling and integration support for young people aged 12–27 with a migration background (and their parents) — school, apprenticeship, and administrative matters. Online counselling available.', null, 'jugendmigrationsdienste.de — "Jugendmigrationsdienste (JMD)"', '2026-07-06', true),
('Caritas — Adressen für Migrationsberatung (national locator)', 'https://www.caritas.de/hilfeundberatung/onlineberatung/migration/adressen', 'counseling', 'Official Caritas locator for migration/refugee counselling centres nationwide — search by postal code with adjustable radius. "Kostenlos, anonym und sicher" (free, anonymous, secure).', null, 'Caritas Deutschland — "Adressen für Migrationsberatung"', '2026-07-06', true),
('Diakonie — Flucht & Migration (national info + MBE locator link)', 'https://www.diakonie.de/informieren/unsere-themen/flucht-migration', 'counseling', 'Official Diakonie page on refugee and migration services — counselling, integration programs, naturalization support; links onward to the shared migrationsberatung.org locator. Free.', null, 'Diakonie Deutschland — "Flucht & Migration"', '2026-07-06', true),
('DRK — Hilfe für Geflüchtete in Deutschland (national info + services)', 'https://www.drk.de/hilfe-in-deutschland/migration-integration-und-teilhabe/hilfe-fuer-gefluechtete-in-deutschland/', 'counseling', 'Official German Red Cross (DRK) page on refugee support — orientation counselling, help accessing benefits/healthcare/schooling/housing, plus the DRK Search Service for family reunification.', null, 'DRK e.V. — "Hilfe für Geflüchtete in Deutschland"', '2026-07-06', true),
('AWO — Migrationsberatung (national info + locator)', 'https://awo-migrationsberatung.org/de/', 'counseling', 'Official AWO (Arbeiterwohlfahrt) migration counselling for newly arrived adults — employment, language courses, housing, school enrolment. Free; multilingual; postal-code/city "Beratungsstelle finden" locator.', null, 'AWO — "Migrationsberatung"', '2026-07-06', true),
('ZWST — Migrationsberatung (MBE)', 'https://zwst.org/en/node/47', 'counseling', 'Official Zentralwohlfahrtsstelle der Juden in Deutschland (ZWST, one of the six recognized welfare associations) MBE program — counselling for adult immigrants, with emphasis on Jewish migrants from Eastern Europe/former USSR and Ukrainian refugees, mostly at Jewish community facilities. Federally funded MBE program.', null, 'ZWST — "Migrationsberatung (MBE)"', '2026-07-06', true),
('Der Paritätische — Schwerpunkt Migration (umbrella info + MBE)', 'https://www.der-paritaetische.de/themen/migration-und-internationale-kooperation/migration/', 'counseling', 'Official Der Paritätische Gesamtverband migration hub — MBE counselling, integration/language initiatives, EU-citizen rights info, and asylum-procedure publications.', null, 'Der Paritätische Gesamtverband — "Schwerpunkt Migration"', '2026-07-06', true),
('Flüchtlingszentrum Hamburg — Flüchtlingsberatung', 'https://www.fz-hh.de/de/projekte/fluechtlingsberatung.php', 'counseling', 'Hamburg refugee-support NGO — orientation and perspectives counselling for newly arrived refugees (residency law, employment, integration options) and referral to social services. Funded by Hamburg''s Sozialbehörde and UNO-Flüchtlingshilfe (UNHCR).', 'hamburg', 'Flüchtlingszentrum Hamburg — "Die Flüchtlingsberatung"', '2026-07-06', true),
('Caritas Köln — Geflüchtete (Cologne)', 'https://www.caritas-koeln.de/hilfe-beratung/fluechtlinge-einwandernde/', 'counseling', 'Cologne Caritas refugee counselling — legal consultation, housing assistance, labour-market integration, language help, and trauma-informed support for survivors of torture/flight.', 'cologne', 'Caritasverband für die Stadt Köln e.V. — "Geflüchtete"', '2026-07-06', true),
('Pro Asyl — Lokale Beratungsstellen (national directory + own advisory line)', 'https://www.proasyl.de/beratungsstellen-vor-ort/', 'legal_advice', 'Pro Asyl (refugee-rights NGO) directory linking to the 16 state refugee councils'' local counselling databases; where no local option exists, Pro Asyl''s own advisors help directly.', null, 'Pro Asyl — "Lokale Beratungsstellen für Flüchtlinge und Migrant*innen"', '2026-07-06', true),
('Landesflüchtlingsräte — fluechtlingsrat.de (umbrella of the 16 state councils)', 'https://www.fluechtlingsrat.de/', 'legal_advice', 'Umbrella site listing and linking to all 16 German state refugee councils (Landesflüchtlingsräte) — independent advocacy and legal/social-advice networks, part of the Pro Asyl network.', null, 'fluechtlingsrat.de — "Die Landesflüchtlingsräte"', '2026-07-06', true),
('Flüchtlingsrat Berlin (Berlin)', 'https://fluechtlingsrat-berlin.de/', 'legal_advice', 'Berlin state refugee council — legal and social counselling, hardship-case support, asylum-procedure advice, and directories of Berlin counselling centres. Part of the Landesflüchtlingsräte / Pro Asyl network.', 'berlin', 'Flüchtlingsrat Berlin e.V. — homepage', '2026-07-06', true),
('Bayerischer Flüchtlingsrat — Beratung (Munich/Bavaria)', 'https://www.fluechtlingsrat-bayern.de/beratung/', 'legal_advice', 'Bavarian state refugee council — phone/email counselling on asylum procedure and residence law for refugees, volunteers and professionals, plus a women''s consultation line. Appointment required ("Keine Beratung ohne Termin").', 'munich', 'Bayerischer Flüchtlingsrat — "Beratung im Asylverfahren und Aufenthaltsrecht"', '2026-07-06', true),
('BMAS — Leistungssätze nach dem Asylbewerberleistungsgesetz (official benefit-rate source)', 'https://www.bmas.de/DE/Soziales/Sozialhilfe/LeistungenAsylbewerberleistungsgesetz/leistungssaetze-asylbewerberleistungsgesetz.html', 'social_welfare', 'Official Federal Ministry of Labour and Social Affairs (BMAS) page with the current AsylbLG (Asylum Seekers'' Benefits Act) benefit rates. Rates are re-set by law periodically — this page always holds the current official figures.', null, 'BMAS — "Neue Leistungssätze nach dem Asylbewerberleistungsgesetz"', '2026-07-06', true),
('Verbraucherzentrale — Gesundheitsleistungen für Asylsuchende (health entitlements explainer)', 'https://www.verbraucherzentrale.de/wissen/gesundheit-pflege/aerzte-und-kliniken/welche-gesundheitsleistungen-stehen-asylsuchenden-zu-12312', 'health', 'Consumer-protection explainer on the healthcare asylum seekers are entitled to under the AsylbLG — acute illness/pain treatment, maternity care, vaccinations and child screenings during an initial waiting period, with broader statutory-equivalent coverage afterwards. Free to read.', null, 'Verbraucherzentrale — "Welche Gesundheitsleistungen stehen Asylsuchenden zu?"', '2026-07-06', true),
